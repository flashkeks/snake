...
const GYMS = [
    { id: 'sprout', name: 'Sprout Gym', icon: '🌱', leader: 'Scout Mika', type: 'nature', rar: ['common'], mul: 1.1, smart: 0, coins: 3000, pack: 'anime' },
    { id: 'tide', name: 'Tide Gym', icon: '💧', leader: 'Captain Ren', type: 'water', rar: ['common', 'uncommon'], mul: 0.9, smart: 1, coins: 4000, pack: 'film' },
