...
| Skill-Baum-Reset zu teuer | `L.resetCost(resets, true)` für Bäume: ein Viertel (12.500 Coins + 625 Scrap, je Reset ×1,5). Nachgezogen: der gemeinsame Knopf „Reset stats (all trees)“ ist weg, der Server lehnt `what: 'stats'` ab. Stat-Punkte lassen sich damit nicht mehr zurücksetzen (Admin-Panel kann es weiter). |
