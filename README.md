...
| Skill-Baum-Reset zu teuer | `L.resetCost(resets, true)` für Bäume: ein Viertel (12.500 Coins + 625 Scrap, je Reset ×1,5). Nachgezogen: der eigene Knopf „Reset stats (all trees)“ ist weg, der Server lehnt `what: 'stats'` ab. Dafür setzt der Baum-Reset die Stats gleich mit zurück (sie gelten für alle Modi), Knopf heißt „Reset … tree + stats“. |
